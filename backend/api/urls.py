...
urlpatterns = [
    ...
    path( "recordings/<int:recording_id>/", views.delete_recording, name="delete_recording", ),
    path( "recording-detail/<int:recording_id>/", views.recording_detail, name="recording_detail", ),
