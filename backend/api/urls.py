...
urlpatterns = [
    ...
    path( 'edit-lesson/<int:lesson_id>/sentence/<int:sentence_id>/', views.edit_lesson, name='edit_lesson_sentence' ),
    ...
    path( "recordings/<int:recording_id>/", views.recordings, name="recording"),
    path( "recordings/", views.recordings, name="recordings"),
    path('channels/', views.channels, name='channels'),
    path( "channels/<int:channel_id>/", views.channels, name="channel"),
